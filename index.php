...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="./assets/img/mombasalogo.png">
  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-transparent " color-on-scroll="100">
    <div class="container">
      <div class="navbar-translate">
        <a class="navbar-brand" href="#" rel="tooltip" title="Mombasa county citizen service" data-placement="bottom" target="_blank">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link btn btn-default d-none d-lg-block" href="javascript:void(0)" onclick="scrollToDownload()">
              <i class="tim-icons icon-cloud-download-93"></i> Register
            </a>
          </li>
        </ul>
      </div>
    ...
    <div class="page-header header-filter">
      ...
      <div class="container">
        <div class="content-center brand">
          <h1 class="h1-seo">Mombasa | county</h1>
